...
[![Deploy](https://www.herokucdn.com/deploy/button.png)](https://dashboard.heroku.com/new?template=https://github.com/makemax-wood/v2ray-heroku)
...
| 变量 | 默认值 | 说明 |
| :--- | :--- | :--- |
| `ID` | `610f55d0-a38c-476a-b0f1-aa6473426a93` | VMess 用户主 ID，用于身份验证，为 UUID 格式 |
